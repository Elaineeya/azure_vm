...
#PUBLIC_IP=$(curl -H  Metadata:true "http://169.254.169.254/metadata/loadbalancer?api-version=2023-11-15" | jq --raw-output ".loadbalancer.publicIpAddresses[0].frontendIpAddress")
